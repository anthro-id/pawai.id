...
export const HotelReservationContext = 
  createContext<string | null>(null);
...
export const textShadow: string =
  "0px 6px 5px rgba(11, 9, 8, 0.75)";

export const lighterTextShadow: string =
  "rgba(11, 9, 8, 0.675) 0px 6px 10px";

export const filterDropShadowValue: string = 
  "drop-shadow(5px 5px 25px #12111280)";